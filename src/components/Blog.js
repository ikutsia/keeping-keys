...
const Blog = ({ language }) => {
  ...
  const categories = [
    ...
    { id: 'survivor-stories', name: { en: 'Survivor Stories', ge: 'გადარჩენილების ისტორიები' } },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="md:flex">
              ...
              <div className="md:w-2/3 p-8">
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-gray-500 ml-4">{formatDate(blogPosts[0].date)}</span>
                </div>
                <h3 className="text-2xl font-bold text-georgian-black mb-4">
                  {language === 'EN' ? blogPosts[0].title.en : blogPosts[0].title.ge}
                </h3>
                <p className="text-gray-600 mb-4">
                  {language === 'EN' ? blogPosts[0].excerpt.en : blogPosts[0].excerpt.ge}
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">
                    {language === 'EN' ? blogPosts[0].author.en : blogPosts[0].author.ge}
                  </span>
                  <span className="text-sm text-gray-500">
                    {language === 'EN' ? blogPosts[0].readTime.en : blogPosts[0].readTime.ge}
                  </span>
                </div>
            ...
            <article key={post.id} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                <div className="flex items-center mb-3">
                  ...
                  <span className="text-gray-500 text-sm ml-auto">{formatDate(post.date)}</span>
                </div>
        ...
        <div className="mt-16 bg-georgian-red rounded-lg p-8 text-center text-white">
          ...
          <div className="flex max-w-md mx-auto">
            <input
              type="email"
              placeholder={language === 'EN' ? 'Enter your email' : 'შეიყვანეთ თქვენი ელ-ფოსტა'}
              className="flex-1 px-4 py-2 rounded-l-lg text-black focus:outline-none"
            />
            <button className="bg-georgian-black px-6 py-2 rounded-r-lg hover:bg-gray-800 transition-colors duration-200">
